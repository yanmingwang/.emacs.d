...
a large theme."
  ...
  (color-theme-install
   '(color-theme-dark-blue2
     ...
     (semantic-dirty-token-face ((t (:background "blue"))))
     (semantic-intangible-face ((t (:foreground "blue"))))
     (semantic-read-only-face ((t (:background "blue"))))
     (semantic-unmatched-syntax-face ((t (:underline "red"))))
     (senator-intangible-face ((t (:foreground "blue"))))
     (senator-momentary-highlight-face ((t (:background "gray70"))))
     (senator-read-only-face ((t (:background "#664444"))))
     (sgml-comment-face ((t (:foreground "dark turquoise"))))
